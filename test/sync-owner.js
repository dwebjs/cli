...
test('sync-owner - default opts', function(t) {
    ...
    function downloadDat() {
        ...
        DWeb(downloadDir, { key: key }, function(err, tmpDat) {
            ...
            downDat.network.flock.once('connection', function() {
...
// HELP. Maybe related to https://github.com/datproject/@dwebjs/core/issues/71
